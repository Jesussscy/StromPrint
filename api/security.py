...
class SecurityHeadersMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next):
        ...
        response.headers["Content-Security-Policy"] = (
            ...
            "img-src 'self' data: blob: https://*.tile.openstreetmap.org https://server.arcgisonline.com https://*.cartocdn.com; "
            "connect-src 'self' https://api.open-meteo.com https://server.arcgisonline.com https://elevation3d.arcgis.com; "
            "font-src 'self' data:; "

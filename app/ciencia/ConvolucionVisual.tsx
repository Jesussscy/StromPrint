  ...
  return (
    <div className="glass rounded-2xl p-6">
          ...
          <button
            ...
            className={`rounded-lg px-4 py-2 font-mono text-[11px] uppercase tracking-wider transition ${
              paso === i
                ...
                : "bg-ocean text-slate-400 border border-white/5 hover:text-white"
            }`}
          >
            Paso {i + 1}
          </button>
      ...
      <motion.div
        ...
        className="rounded-xl bg-ocean p-5 border border-white/5"
      >
        ...
        <div className="mt-4 rounded-lg bg-ocean-mid p-3 border-l-2 border-cyan font-mono text-cyan text-center text-sm">
          {activo.formula}
        </div>
      </motion.div>

      <div className="mt-4 grid gap-2 sm:grid-cols-3 text-center text-[11px]">
        <div className="rounded-lg bg-ocean p-2 text-slate-500">
        ...
        <div className="rounded-lg bg-ocean p-2 text-emerald-400/80">

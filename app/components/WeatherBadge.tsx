...
function WeatherIcon({ lluvia }: { lluvia: number }) {
  ...
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#E9C46A" strokeWidth="2">
...
export default function WeatherBadge({ meteorologia, isLoading }: WeatherBadgeProps) {
  if (isLoading) {
    return (
      <div className="flex items-center gap-2 rounded-lg bg-navy-light/60 px-3 py-1.5">
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}
      className="flex flex-wrap items-center gap-3 rounded-lg bg-navy-light/60 px-3 py-1.5"
    >
      ...
      <div className="h-4 w-px bg-navy-lighter" />
      <div className="flex items-center gap-1.5">
        <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#00B4D8" strokeWidth="2"><path d="M12 2.69l5.66 5.66a8 8 0 1 1-11.31 0z" /></svg>
